...
export default function InfluencerApplyWrapper() {
  return (
...
function InfluencerApplyPage() {
  ...
  const onAppy = async () => {
    ...
    executeRecaptcha("influencerApplyFormSubmit").then((gReCaptchaToken) => {

      submitInfluencerApply(gReCaptchaToken);
    });
    setIsLoading(false);
  };
  const submitInfluencerApply = (gReCaptchaToken: string) => {
      ...
      if (response?.data?.success === true) {
        await axios.post("/api/sendEmail", {
          ...
          html: `
            ...
            <br/>https://influencer-meguri.jp/applyInfluencer?id=${response.data.data.hash}
            <br/>
            <br/>-----------------------------------------------------
      ...
      <div className="bg-[white] text-center px-[20px] mobile:px-[40px] w-[614px] sp:w-[90%] rounded-[40px] block m-auto py-[70px] sp:py-[20px] shadow-lg">
        ...
        <div className="w-full flex justify-center">
          <div className="block m-auto">
            <div className="ml-[70px] mobile:ml-[0px]  sp:ml-0 mobile:text-left text-left">
